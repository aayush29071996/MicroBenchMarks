...
for i in range(0,len(a)/16):
    b.append(a[i])
for i in range(len(a)/16,len(a)/8):
    c.append(a[i])
for i in range(len(a)/8, (3*len(a))/16):
    d.append(a[i])
for i in range((3*len(a))/16, len(a)/4  ):
    e.append(a[i])
for i in range(len(a)/4, (5*len(a))/16):
    f.append(a[i])
for i in range((5*len(a))/16, (3*len(a))/8):
    g.append(a[i])
for i in range( (3*len(a))/8 ,(7*len(a))/16):
    h.append(a[i])
for i in range((7*len(a))/16,len(a)/2):
    k.append(a[i])
for i in range(len(a)/2, (9*len(a))/16):
    bi.append(a[i])
for i in range((9*len(a))/16,(5*len(a))/8):
    ci.append(a[i])
for i in range((5*len(a))/8,(11*len(a))/16):
    di.append(a[i])
for i in range((11*len(a))/16,(3*len(a))/4):
    ei.append(a[i])
for i in range((3*len(a))/4,(13*len(a))/16):
    fi.append(a[i])
for i in range((13*len(a))/16, (7*len(a))/8):
    gi.append(a[i])
for i in range((7*len(a))/8,(15*len(a))/16):
    hi.append(a[i])
for i in range((15*len(a))/16,len(a)):
    ii.append(a[i])
...
index = 0
while index < len(fi):
    f12.append(float(fi[index]))
    index += 3
index = 1
while index < len(fi):
    date_time_obj = datetime.datetime.strptime(fi[index], ' %Y-%m-%d %H:%M:%S.%f ')
    time = date_time_obj
    g12.append(time)
    index += 3
index = 2
...
index = 0
while index < len(gi):
    f13.append(float(gi[index]))
    index += 3
index = 1
while index < len(gi):
    date_time_obj = datetime.datetime.strptime(gi[index], ' %Y-%m-%d %H:%M:%S.%f ')
    time = date_time_obj
    g13.append(time)
    index += 3
index = 2
...
index = 0
while index < len(hi):
    f14.append(float(hi[index]))
    index += 3
index = 1
while index < len(hi):
    date_time_obj = datetime.datetime.strptime(hi[index], ' %Y-%m-%d %H:%M:%S.%f ')
    time = date_time_obj
    g14.append(time)
    index += 3
index = 2
...
index = 0
while index < len(ii):
    f15.append(float(ii[index]))
    index += 3
index = 1
while index < len(ii):
    date_time_obj = datetime.datetime.strptime(ii[index], ' %Y-%m-%d %H:%M:%S.%f ')
    time = date_time_obj
    g15.append(time)
    index += 3
index = 2
...
for a in range(12):
    ...
    speedEvent24 = []
    speedEvent24.append(f12[a])
    speedEvent24.append(g12[a])
    events.append(speedEvent24)
    speedEvent25 = []
    speedEvent25.append(-f12[a])
    speedEvent25.append(h12[a])
    events.append(speedEvent25)
    speedEvent26 = []
    speedEvent26.append(f13[a])
    speedEvent26.append(g13[a])
    events.append(speedEvent26)
    speedEvent27 = []
    speedEvent27.append(-f13[a])
    speedEvent27.append(h13[a])
    events.append(speedEvent27)
    speedEvent28 = []
    speedEvent28.append(f14[a])
    speedEvent28.append(g14[a])
    events.append(speedEvent28)
    speedEvent29 = []
    speedEvent29.append(-f14[a])
    speedEvent29.append(h14[a])
    events.append(speedEvent29)
    speedEvent30 = []
    speedEvent30.append(f15[a])
    speedEvent30.append(g15[a])
    events.append(speedEvent30)
    speedEvent31 = []
    speedEvent31.append(-f15[a])
    speedEvent31.append(h15[a])
    events.append(speedEvent31)
